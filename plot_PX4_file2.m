...
%% NKF1
if exist('NKF1','var');
    freq = calc_data_frequency(NKF1.t);
    figure(gcf+1); clf; hold all; set(gcf,'name',['NKF1 Data - ',num2str(freq,'%.0f'),' Hz']);
return
end
...
%% WING
if exist('WING','var') && (plot_all || plot_VIBE);
    freq = calc_data_frequency(WING.t);
    figure(gcf+1);clf; hold all; set(gcf,'name',['WING - ',num2str(freq,'%.0f'),' Hz']);
    subplot(4,1,1); hold all; ...
        plot(WING.t,WING.rpm1);
    subplot(4,1,2); hold all; ...
        plot(WING.t,WING.rpm2);
    subplot(4,1,3); hold all; ...
        plot(WING.t,WING.rpm3);
    subplot(4,1,4); hold all; ...
        plot(WING.t,WING.rpm4);
    
%     return
%         subplot(4,1,1); hold all; ...
%         plotyy(WING.t,WING.rpm1,RCOU.t,RCOU.Ch1);
%     subplot(4,1,2); hold all; ...
%         plotyy(WING.t,WING.rpm2,RCOU.t,RCOU.Ch4);
%     subplot(4,1,3); hold all; ...
%         plotyy(WING.t,WING.rpm3,RCOU.t,RCOU.Ch3);
%     subplot(4,1,4); hold all; ...
%         plotyy(WING.t,WING.rpm4,RCOU.t,RCOU.Ch2);
